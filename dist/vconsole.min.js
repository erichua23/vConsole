...
/***/ function(module, exports, __webpack_require__) {
	...
	var _item_fold = __webpack_require__(27);

	var _item_fold2 = _interopRequireDefault(_item_fold);

	var _item_fold_code = __webpack_require__(28);
	...
	var VConsoleLogTab = function (_VConsolePlugin) {
	  ...
	  _createClass(VConsoleLogTab, [{
	    ...
	    value: function onInit() {
	      ...
	      this.$vclog = _query2.default.one('.vc-log', this.$tabbox);
	    }
	      ...
	      for (var _i = 0; _i < logs.length; _i++) {
	        ...
	        try {
	          if (logs[_i] === '') {
	            // ignore empty string
	            continue;
	          } else if (tool.isFunction(logs[_i])) {
	            // convert function to string
	            log = '<span> ' + logs[_i].toString() + '</span>';
	          } else if (tool.isObject(logs[_i]) || tool.isArray(logs[_i])) {
	            // object or array
	            log = this.getFoldedLine(logs[_i]);
	          } else {
	            // default
	            log = tool.htmlEncode(logs[_i]).replace(/\n/g, '<br/>');
	          }
	        } catch (e) {
	          log = _typeof(logs[_i]);
	        }
	          ...
	          */
	          ...
	          if (this.$vclog.childNodes.length > 300) {
	            for (var _i = 0; _i < 50; _i++) {
	              this.$vclog.childNodes[_i] && this.$vclog.removeChild(this.$vclog.childNodes[_i]);
	            }
	          }
...
/***/ function(module, exports) {
	...
	module.exports = "<div>\n  <div class=\"vc-log\" style=\"padding-bottom:40px\">\n  </div>\n  <form class=\"vc-cmd\">\n    <button class=\"vc-cmd-btn\" type=\"submit\">OK</button>\n    <div class=\"vc-cmd-input-wrap\">\n      <textarea class=\"vc-cmd-input\" placeholder=\"command...\"></textarea>\n    </div>\n  </form>\n</div>\n";
